...
/**
 * Precompiled io.github.snyk.java-conventions script plugin.
 **/
public class IoGithubSnykJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_IoGithubSnykJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_IoGithubSnykJavaConventions").asSubclass(BasicScript.class);
